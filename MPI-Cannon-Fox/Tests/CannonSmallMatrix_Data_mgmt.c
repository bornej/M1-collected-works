...
int main(int argc, char **argv){
    ...
    if (rank == 0){
        printf("---------------------------------------------------------\n");
        printf("---      Cannon Small Matrix + Data Management test   ---\n");
        printf("---------------------------------------------------------\n");
    }
    ...
    snprintf(filename, 256, "%s%d%c%d", "./Results/SmallMatrixCannon_DataMgmt/A_", myLineRank, '_', myColRank);
    ...
    if(rank == 0){
        snprintf(filename, 256, "%s", "./Results/SmallMatrixCannon_DataMgmt/C");
        f[rank] = fopen(filename, "w");
